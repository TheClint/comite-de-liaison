...
class DepartementSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $tabDepReg = [
            ...
            '04' => [ 'departement' => "Alpes-de-Haute-Provence", 'region' => "Provence-Alpes-Côte d'Azur"],
            '05' => [ 'departement' => "Hautes-Alpes", 'region' => "Provence-Alpes-Côte d'Azur"],
            '06' => [ 'departement' => "Alpes-Maritimes", 'region' => "Provence-Alpes-Côte d'Azur"],
            ...
            '13' => [ 'departement' => "Bouches-du-Rhône", 'region' => "Provence-Alpes-Côte d'Azur"],
            ...
            '90' => [ 'departement' => "Territoire de Belfort", 'region' => "Bourgogne-Franche-Comté"],
            '91' => [ 'departement' => "Essonne", 'region' => "Île-de-France"],
            '92' => [ 'departement' => "Hauts-de-Seine", 'region' => "Île-de-France"],
            '93' => [ 'departement' => "Seine-St-Denis", 'region' => "Île-de-France"],
        ...
        foreach($tabDepReg as $numero => $depReg){
            DB::table('departements')->insert([
                'numero' => $numero,
                'nom' => $depReg['departement'],
                'region_id' => DB::table('regions')
                    ->where('nom', $depReg['region'])
                    ->get()[0]->id,
            ]);
        }
    }
